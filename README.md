# 🌋 Seismology. ETL-конвейер.


## 📋 Обзор проекта

Данный проект представляет собой ETL-конвейер(хотя немного ELT получилось) для ежедневного сбора, обработки и агрегации глобальных сейсмических данных.
...
Проект охватывает полный цикл дата-инжиниринга: от настройки инфраструктуры до доставки витрин данных.
...
2. **RAW -> ODS:**
    ...
    * Использование ClickHouse для быстрого перемещения данных.
